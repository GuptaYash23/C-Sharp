...
Collection is a set of hetrogeneous elements.
...
These collections can store any type of object, but they do not provide type safety, which can lead to runtime errors if the wrong type is used. They can store homogeneous elements as well as hetrogeneous elements. All non-generic collections unlike fixed size structures like array can automatically resize dynamically (auto resize)
